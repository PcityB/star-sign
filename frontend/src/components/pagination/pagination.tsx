...
const Pagination = ({
  ...
  const totalPages = useMemo(() => calculateTotalPages(pageSize, totalItemsCount), [totalItemsCount, pageSize]);
  ...
  return (
    ...
    >
      <div className={getValidClassNames(styles['pagination-container'], styles['container'])}>
        <p className={styles['text']}>
          Page {page} of {totalPages}
        </p>
        <div className={getValidClassNames(styles['change-page-buttons-container'], styles['container'])}>
          <IconButton
