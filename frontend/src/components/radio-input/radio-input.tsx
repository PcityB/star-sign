import { useController, Control, FieldValues, FieldPath, FieldErrors, PathValue } from 'react-hook-form';
...
const RadioInput = <T extends FieldValues>({ label, name, control, options, errors }: Properties<T>) => {
  const {
