...
const SignInForm = ({ onSubmit }: Properties): JSX.Element => {
  ...
  return (
    <form className={styles['form-wrapper']} noValidate onSubmit={handleFormSubmit}>
      <p className={styles['form-text']}>
        Don&apos;t have an account? <Link to={AppPath.SIGN_UP}>Create new</Link>
      </p>
      <Input autoComplete="username" control={control} errors={errors} label="Email" name="email" type="email" />
